...
export const INITIAL_STUDENTS: Student[] = [
  ...
  },
  {
    ...
    className: '中班 (草莓班)',
    gender: 'boy',
    avatarUrl: 'https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?w=200&auto=format&fit=crop&q=80',
    parentName: '王媽媽',
    parentContact: '0966-123-456',
    notes: '熱情活潑，喜歡塗鴉與律動遊戲。',
  },
  {
    id: 'stu-06',
    name: '許蘋果',
    ...
    className: '小班 (蘋果班)',
    gender: 'girl',
    avatarUrl: 'https://images.unsplash.com/photo-1516627145497-ae6968895b74?w=200&auto=format&fit=crop&q=80',
    parentName: '許爸爸',
    parentContact: '0977-222-333',
    notes: '愛笑好學，喜愛美勞操作與歌唱。',
  },
  {
    id: 'stu-07',
    name: '周葡萄',
    ...
    avatarUrl: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=200&auto=format&fit=crop&q=80',
    parentName: '周媽媽',
    parentContact: '0988-333-444',
    notes: '適應良好，吃飯乖巧，喜歡聽故事。',
  },
];
...
export const INITIAL_LEARNING_RECORDS: LearningRecord[] = [
  ...
  },
  {
    ...
    customNotes: {
      language: '使用圖卡進行文字配對遊戲，速度極快。',
      watercolor: '渲染水彩技巧進步神速。',
      art: '利用黏土搓揉各種小動物作品。',
      beads: '',
      science: '觀察磁鐵吸引金屬物件的實驗。',
      brain: '',
      puzzle: '',
      blocks: '搭建大型城堡並扮演小騎士。',
    },
    photoImages: [
      ...
      'https://images.unsplash.com/photo-1587691592099-24045742c181?w=800&auto=format&fit=crop&q=80',
    ],
    teacherComment: '第二週觀察記錄：小花在積木區與藝術區表現非常突出，展現很棒的社交互動與專注力。',
    stamp: '特別優秀',
